...
# Install GHC 9.6.4
python3 -c "import wget; wget.download('https://downloads.haskell.org/~ghc/9.6.4/ghc-9.6.4-aarch64-deb10-linux.tar.xz', '/tmp/ghc-9.6.4.tar.xz')"
python3 -c "import shutil; shutil.unpack_archive('/tmp/ghc-9.6.4.tar.xz', '/tmp')"
(mv "/tmp/ghc-9.6.4-aarch64-unknown-linux" "/tmp/ghc-9.6.4")
